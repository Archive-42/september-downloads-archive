      ...
      return knex("steps").insert([
        {
          step_number: 1,
          step_instructions:
            "Place your skillet on the stovetop and turn on the heat",
          recipe_id: 1,
        },
        {
          step_number: 2,
          step_instructions:
            "Pprepare your eggs. Break them into a bowl with a tablespoon of water or milk, some salt and pepper. I use about 1/8 tsp salt and a pinch of pepper; you might use more or less according to taste",
          recipe_id: 1,
        },
        {
          step_number: 3,
          step_instructions:
            "Lightly grease your hot skillet, coating the surface with a thin layer of oil or butter",
          recipe_id: 1,
        },
        {
          step_number: 4,
          step_instructions: "Pour the eggs into the skillet",
          recipe_id: 1,
        },
        {
          step_number: 5,
        ...
        },
        {
          step_number: 6,
          step_instructions:
            "Move the spatula around the edge of the skillet, pulling the cooked edges towards the center and re-flooding repeatedly",
          recipe_id: 1,
        },
        {
          step_number: 7,
